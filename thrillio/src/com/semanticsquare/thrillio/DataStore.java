...
public static User[] users=new User[TOTAL_COUNT];
...
private static UserBookmark[] userBookmarks=new UserBookmark[TOTAL_COUNT*USER_BOOKMARK_LIMIT];
...
private static void loadBooks() {
	...
	bookmarks[2][4]=BookmarkManager.getInstance().createBook(4004,	"Effective Java Programming Language Guide",	2007	,"Prentice Hall",new String[] {"Joshua Bloch"}, BookGenre.PHILOSOPHY,	4.9);
